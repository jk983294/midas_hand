 ...
 */
public class GpStrategyM extends SingleStockStrategyBase {

    public final static String STRATEGY_NAME = "GpStrategyM";
    ...
    public GpStrategyM(List<StockVo> allStocks, CalcParameter parameter) throws MidasException {
